...
router.post('/advTransferTo', async function (req, res, next) {
  // TODO
  // uint256 cannot store float
  /*
  let bank = new web3.eth.Contract(contract.abi);
  bank.options.address = req.body.address;
  console.log("old value: "+parseInt(req.body.value,10))
  console.log("gasprice: "+await web3.eth.getGasPrice())
  */
  let weiValue = parseInt(req.body.value,10) * Math.pow(10,18)
  /*
  console.log("weiValue: "+weiValue)
  let ethValue = weiValue/Math.pow(10,18)
  console.log("ethValue: "+ethValue)
  bank.methods.transfer(req.body.to,ethValue).send({
    from: req.body.account,
    gas: 3400000
  })
    .on('receipt', function (receipt) {
